            ...
            <div class="row clearfix">
                ...
                <div class="card member-card">
                    <div class="header primary-bg">
                        <h4 class="m-t-10 text-light">PORTAIL ETUDIANT</h4>
                    </div>
                    <div class="member-img">
                        <a href="javascript:void(0);"><img src="/assets/images/lg/avatar6.jpg" class="rounded-circle" alt="profile-image"></a>
                    </div>
                    <div class="body">
                        <div class="row text-center border-bottom pb-2">
                            <div class="col-md-6 border-right">
                                <label class="d-block text-muted mb-1">Nom</label>
                                <h6> <p>{{ etudiant.etudiant.nomEtudiant }}</p></h6>
                            </div>
                            <div class="col-md-6">
                                <label class="d-block text-muted mb-1">Prenom</label>
                                <h6> {{ etudiant.etudiant.prenomEtudiant }}</h6>
                            </div>
                        </div>
                        <div class="row text-center mt-2 border-bottom pb-2">
                            <div class="col-md-6 border-right">
                                <label class="d-block text-muted mb-1">Date Naissance</label>
                                <h6>{{ etudiant.etudiant.dateNaissance }}</h6>
                            </div>
                            <div class="col-md-6">
                                <label class="d-block text-muted mb-1">Telephone</label>
                                <h6>{{ etudiant.etudiant.telephoneEtudiant }}</h6>
                            </div>
                        </div>
                        <div class="row text-center mt-2 border-bottom pb-2">
                            <div class="col-md-12">
                                <label class="d-block text-muted mb-1">Adresse</label>
                                <h6>{{ etudiant.etudiant.adresseEtudiant }}</h6>
                            </div>
                        </div>
                        <div class="row text-center mt-2 border-bottom pb-2">
                            <div class="col-md-12">
                                <label class="d-block text-muted mb-1">Email</label>
                                <h6>{{ etudiant.etudiant.emailEtudiant }}</h6>
                            </div>
                        </div>
                                    ...
                                    <div class="row clearfix">
                                        <div class="col-lg-12 col-md-12">
                                            <div class="form-group">                                                
                                                <input type="text" class="form-control" v-model="etudiant.etudiant.nomEtudiant"  placeholder="Nom" readonly>
                                            </div>
                                            <div class="form-group">                                                
                                                <input type="text" class="form-control" v-model="etudiant.etudiant.prenomEtudiant" placeholder="Prenom" readonly>
                                            </div>
                                        ...
                                        <div class="col-lg-12 col-md-12">
                                            <div class="form-group">                                                
                                                <input type="text" class="form-control" v-model="form.adresseEtudiant" placeholder="Adresse">
                                            </div>
                                            <div class="form-group">
                                                <input type="text" class="form-control" v-model="form.telephoneEtudiant" placeholder="Telephone">
                                            </div>
                                            
                                        </div>
                                    </div>
                                    <button type="button" class="btn btn-primary" @click="updateEtudiant()">Mise a jour</button> &nbsp;&nbsp;
                                ...
                                <div class="body">
                                    <div class="row clearfix">
                                        <div class="col-lg-12 col-md-12">
                                            ...
                                            <div class="form-group">
                                                <input type="email" class="form-control" v-model="etudiant.etudiant.emailEtudiant" placeholder="Email" readonly>
                                            </div>
...
export default {
    ...
    data() {
        return {
            form: new Form({
                adresseEtudiant: this.etudiant.adresseEtudiant,
                telephoneEtudiant: this.etudiant.telephoneEtudiant
            }),
    ...
    methods: {
        async updateEtudiant() {
            ...
            if (this.form.adresseEtudiant === '' || this.form.telephoneEtudiant === '') {
            ...
            try {
                ...
                await this.form.put(`/api/etudiant/profil/${this.etudiant.id}`, {
                    adresseEtudiant: this.form.adresseEtudiant,
                    telephoneEtudiant: this.form.telephoneEtudiant
                });
        ...
        async updatePassword() {
            ...
            console.log('Utilisateur connecté :', this.etudiant);

            try {
                const response = await axios.put(`/api/etudiant/profil/${this.etudiant.id}/password`, {
