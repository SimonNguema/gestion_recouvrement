                    ...
                    <div class="row clearfix">
                        <div class="col-md-4">
                            <div class="body primary-bg text-light">
                                <h4><i class="fa fa-bank"></i> {{ montantTotalEncaisse }} FCFA</h4>
            ...
            <div class="col-lg-12 col-md-12">
                <div class="card">
                    ...
                    <div class="body">
                        ...
                        <p><a :href='"/admin/encaissement/index"'> AFFICHER TOUS L'HISTORIQUE</a></p>
        ...
        <div class="row clearfix" style="margin-top: 10px;">
                <div class="col-md-6">
                    <div class="card">
                        ...
                        <a :href='"/admin/etudiant/index"'>AFFICHER TOUS</a>                        
                ...
                <div class="col-md-6">
                       <div class="card">
                           ...
                           <a :href='"/admin/programme/index"'>AFFICHER TOUS</a>    
        ...
        <div class="row clearfix" style="margin-top: 10px;">
                   <div class="col-md-12">
                       <div class="card">
                           ...
                           <a :href='"/admin/engagement/index"'>AFFICHER TOUS</a>    
                       </div>
...
export default {
    ...
    methods:{
        ...
        async getEncaissement() {
            try {
                const response = await axios.get("/api/admin/dashboard/indexEncaissement");
                this.encaissement = response.data.encaissement; 
                this.montantTotalEncaisse = response.data.totalMontantEncaisse;
        ...
        async getEtudiant() {
            try {
                const response = await axios.get("/api/admin/dashboard/indexEtudiant");
        ...
        async getEngagement() {
                try {
                    const response = await axios.get("/api/admin/dashboard/indexEngagement");
        ...
        async getProgramme() {
            try {
                const response = await axios.get("/api/admin/dashboard/indexProgramme");
